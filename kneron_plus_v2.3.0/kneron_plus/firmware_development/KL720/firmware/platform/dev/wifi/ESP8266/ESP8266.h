...
*/
extern int32_t AT_Cmd_SetSSLConf(uint32_t at_cmode,uint16_t mode);

#if WIFI_ESP8266_SSL_SIZE_CONFIG
/**
  Set SSL buffer size.
  ...
  \return execution status:
	...
	\note Supports the establishment of up to 1 SSL connection
*/
extern int32_t AT_Cmd_SetSSLSize(uint32_t at_cmode,uint16_t buf_size);
#endif
/**
