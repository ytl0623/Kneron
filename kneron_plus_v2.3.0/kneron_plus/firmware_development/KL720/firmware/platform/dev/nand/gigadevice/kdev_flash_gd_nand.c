...
*  Description:
*  ------------
*  This SPI Flash driver is specific for GigaDevice GD5F1GQ4xExIG and 
*                                                   GD5F1GQ5xExIG SPI Flash Access
*  HW: Faraday FTSPI020
*
******************************************************************************/
#include "cmsis_os2.h"
...
kdev_status_t kdev_flash_check_cumulativeECCstauts(void)
{
    ...
    status = (status & SR3_ECC_CHECK) >> 2;
    status |= (kdrv_spif_get_flash_status(ADR_STATUS_REG_5) & SR3_ECC_CHECK) >> 4;
