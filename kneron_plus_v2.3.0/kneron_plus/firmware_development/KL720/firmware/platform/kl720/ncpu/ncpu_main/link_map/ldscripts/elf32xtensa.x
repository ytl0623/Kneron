/* This linker script generated from xt-genldscripts.tpp for LSP D:\Project\beethoven_sw\firmware\platform\kl720\ncpu\ncpu_main\link_map */
...
MEMORY
{
  ...
  sram8_seg :                         	org = 0x80120340, len = 0xDFCC0
}
...
_memmap_mem_sram_end   = 0x80200000;
...
_memmap_seg_sram8_max   = 0x80200000;

_rom_store_table = 0;
PROVIDE(_memmap_reset_vector = 0x80000000);
PROVIDE(_memmap_vecbase_reset = 0x80120000);
/* Various memory-map dependent cache attribute settings: */
_memmap_cacheattr_wb_base = 0x00010104;
_memmap_cacheattr_wt_base = 0x00030304;
_memmap_cacheattr_bp_base = 0x00040404;
_memmap_cacheattr_unused_mask = 0xFFF0F0F0;
_memmap_cacheattr_wb_trapnull = 0x44414144;
_memmap_cacheattr_wba_trapnull = 0x44414144;
_memmap_cacheattr_wbna_trapnull = 0x44424244;
_memmap_cacheattr_wt_trapnull = 0x44434344;
_memmap_cacheattr_bp_trapnull = 0x44444444;
_memmap_cacheattr_wb_strict = 0x00010104;
_memmap_cacheattr_wt_strict = 0x00030304;
_memmap_cacheattr_bp_strict = 0x00040404;
_memmap_cacheattr_wb_allvalid = 0x44414144;
_memmap_cacheattr_wt_allvalid = 0x44434344;
_memmap_cacheattr_bp_allvalid = 0x44444444;
_memmap_region_map = 0x00000015;
...
SECTIONS
{
  ...
  .libDriver.text : ALIGN(4)
  {
    _libDriver_text_start = ABSOLUTE(.);
    *(.libDriver.literal .libDriver.text)
    . = ALIGN (4);
    _libDriver_text_end = ABSOLUTE(.);
  } >iram0_0_seg :iram0_0_phdr
  ...
  .libDriver.rodata : ALIGN(4)
  {
    _libDriver_rodata_start = ABSOLUTE(.);
    *(.libDriver.rodata)
    . = ALIGN (4);
    _libDriver_rodata_end = ABSOLUTE(.);
  } >sram0_seg :sram0_phdr
  ...
  .libDriver.data : ALIGN(4)
  {
    _libDriver_data_start = ABSOLUTE(.);
    *(.libDriver.data)
    . = ALIGN (4);
    _libDriver_data_end = ABSOLUTE(.);
  } >sram0_seg :sram0_phdr
  ...
  .rodata : ALIGN(4)
  {
    ...
    *(.gnu.version_d)
    ...
    LONG(_dram1_bss_end)
    LONG(_libDriver_bss_start)
    LONG(_libDriver_bss_end)
    LONG(_bss_start)
    LONG(_bss_end)
  ...
  .libDriver.bss (NOLOAD) : ALIGN(8)
  {
    . = ALIGN (8);
    _libDriver_bss_start = ABSOLUTE(.);
    *(.libDriver.bss)
    . = ALIGN (8);
    _libDriver_bss_end = ABSOLUTE(.);
