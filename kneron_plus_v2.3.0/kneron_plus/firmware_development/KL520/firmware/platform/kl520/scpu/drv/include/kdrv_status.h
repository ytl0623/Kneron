...
typedef enum
{
    ...
    KDRV_STATUS_USBD_TRANSFER_TERMINATED,     /**< USBD : transfer is terminated as requested */
    KDRV_STATUS_USBD_TRANSFER_DISCONNECTED,   /**< USBD : transfer is terminated due to reset/disconnect */
