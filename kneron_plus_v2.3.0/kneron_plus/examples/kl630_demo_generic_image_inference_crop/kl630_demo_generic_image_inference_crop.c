...
int main(int argc, char *argv[])
{
    ...
    _input_data.input_node_image_list[0].inf_crop[0].x1 = 860;
    _input_data.input_node_image_list[0].inf_crop[0].y1 = 618;
    _input_data.input_node_image_list[0].inf_crop[0].width = 630;
    _input_data.input_node_image_list[0].inf_crop[0].height = 630;
    _input_data.input_node_image_list[0].inf_crop[1].crop_number = 1;           // crop number for sync, could be specified by user
    _input_data.input_node_image_list[0].inf_crop[1].x1 = 98;
    _input_data.input_node_image_list[0].inf_crop[1].y1 = 583;
    _input_data.input_node_image_list[0].inf_crop[1].width = 600;
    _input_data.input_node_image_list[0].inf_crop[1].height = 600;
    ...
    post_process_yolo_v5_720(output_nodes, _output_desc_0.num_output_node, &_output_desc_0.pre_proc_info[0], 0.15, yolo_result);
    ...
    // post-process yolo v5 output nodes to class/bounding boxes
    post_process_yolo_v5_720(output_nodes, _output_desc_1.num_output_node, &_output_desc_1.pre_proc_info[0], 0.15, yolo_result);
