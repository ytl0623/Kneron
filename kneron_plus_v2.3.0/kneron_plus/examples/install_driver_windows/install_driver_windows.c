...
static bool _install_kl730 = false;
static bool _install_kl830 = false;
...
void print_settings()
{
    ...
    if (0 == strcmp("KL520", _target_platform)) {
        ...
        _install_kl730 = false;
        _install_kl830 = false;
        ...
        _install_kl730 = false;
        _install_kl830 = false;
    } else if (0 == strcmp("KL730", _target_platform)) {
        _install_kl520 = false;
        _install_kl720 = false;
        _install_kl630 = false;
        _install_kl730 = true;
        _install_kl830 = false;
    } else if (0 == strcmp("KL830", _target_platform)) {
        _install_kl520 = false;
        _install_kl720 = false;
        _install_kl630 = false;
        _install_kl730 = false;
    ...
    printf("[arguments]\n");
    printf("    -h     : help\n");
    printf("    -target: [target platform] (ALL, KL520, KL720, KL630, KL730, KL830) = %s\n", _target_platform);
    printf("\n");
    printf("[note]\n");
...
int main(int argc, char *argv[])
{
    ...
    if (true == _install_kl730) {
        printf("Installing driver for KL730 ... ");
        fflush(stdout);
    ...
    if (true == _install_kl830) {
        printf("Installing driver for KL830 ... ");
        fflush(stdout);
