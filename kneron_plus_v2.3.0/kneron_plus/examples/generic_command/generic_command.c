...
void print_settings()
{
    ...
    printf("-target: [target platform] (KL520, KL720, KL630, KL730, KL830) = %s (default: KL520)\n", _target_platform);
    ...
    printf("         Notice that the shutdown command is only supported by KL520 96 board\n");
    printf("\n");
}
...
static void connect_devices()
{
    ...
    else if (0 == strcmp(_target_platform, "KL730"))
        target_product = KP_DEVICE_KL730;
    else if (0 == strcmp(_target_platform, "KL830"))
        target_product = KP_DEVICE_KL830;
    else
    {
