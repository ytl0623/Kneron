/**
 * @file        kl720_kn-model-zoo_generic_inference_post_yolov5.c
 * @brief       main code of kl720 model zoo yolov5 demo (output raw data)
 * @version     1.1
 * @date        2021-07-27
 *
...
static char _model_file_path[128] = "../../res/models/KL720/yolov5-noupsample_w640h640_kn-model-zoo/kl720_20005_yolov5-noupsample_w640h640.nef";
...
int main(int argc, char *argv[])
{
    ...
    kp_inf_float_node_output_t *output_nodes[3] = {NULL}; // three output nodes, described by _output_desc.num_output_node
    ...
    output_nodes[2] = kp_generic_inference_retrieve_float_node(2, raw_output_buf, KP_CHANNEL_ORDERING_HCW);
