...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='KL720 Kneron Model Zoo Generic Data Inference Example - RegNetX.')
    ...
    parser.add_argument('-img',
                        ...
                        default=os.path.join(PWD, '../../res/images/shark_1000x667.jpg'),
                        type=str)
    parser.add_argument('-nef',
                        '--nef_model_path',
                        help='input NEF model path',
                        default=os.path.join(PWD,
                                             '../../res/models/KL720/kn-model-zoo-mmcls_regnetx/example_RegNetX_720.nef'),
                        type=str)
