...
#define regSPIF_ctrl ((volatile U_regSPIF_ctrl *)SPI_FTSPI020_PA_BASE)
#define regSPIF_irq  ((volatile U_regSPIF_irq *)(SPI_FTSPI020_PA_BASE+0x20))
#define regSPIF_info ((volatile U_regSPIF_info *)(SPI_FTSPI020_PA_BASE+0x50))
#define regSPIF_data ((volatile U_regSPIF_data *)(SPI_FTSPI020_PA_BASE+0x100))
