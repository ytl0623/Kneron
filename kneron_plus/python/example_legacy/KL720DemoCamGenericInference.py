...
def _image_send_function(_device_group: kp.DeviceGroup) -> None:
    global _image_to_inference, _generic_raw_image_header, _SEND_RUNNING, _RECEIVE_RUNNING
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='KL720 Demo Camera Generic Inference Example.')
