...
MODEL_FILE_PATH = os.path.join(PWD,
                               '../../res/models/KL720/fcos-drk53s_w512h512_kn-model-zoo/kl720_20004_fcos-drk53s_w512h512.nef')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='KL720 Kneron Model Zoo Generic Image Inference Example - FCOS.')
    ...
    out_data = [tmp[1], tmp[4], tmp[7], sigmoid(tmp[2]), sigmoid(tmp[5]), sigmoid(tmp[8]), sigmoid(tmp[0]),
                sigmoid(tmp[3]), sigmoid(tmp[6])]
