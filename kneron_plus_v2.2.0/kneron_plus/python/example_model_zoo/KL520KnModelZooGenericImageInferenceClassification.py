...
MODEL_FILE_PATH = os.path.join(PWD, '../../res/models/KL520/resnet18_w224h224_kn-model-zoo/kl520_20001_resnet18_w224h224.nef')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='KL520 Kneron Model Zoo Generic Image Inference Example - Classification.')
