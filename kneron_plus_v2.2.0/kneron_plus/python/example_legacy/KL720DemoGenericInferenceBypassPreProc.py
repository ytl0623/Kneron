...
IMAGE_FILE_PATH = os.path.join(PWD, '../../res/images/people_talk_in_street_640x640_rgba8888_normalized.bin')
LOOP_TIME = 50

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='KL720 Demo Generic Inference Bypass Pre-Processing Example.')
    ...
    print(model_nef_descriptor.models[0].input_nodes[0])
    hardware_preproc_info = kp.HwPreProcInfo(img_width=640,
                                             img_height=640,
                                             resized_img_width=640,
                                             resized_img_height=640,
