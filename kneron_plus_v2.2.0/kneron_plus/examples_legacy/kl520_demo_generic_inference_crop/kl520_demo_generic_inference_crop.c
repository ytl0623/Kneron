...
int main(int argc, char *argv[])
{
    ...
    _input_desc.inf_crop[0].x1 = 0;
    _input_desc.inf_crop[0].y1 = 0;
    _input_desc.inf_crop[0].width = 400;
    _input_desc.inf_crop[0].height = 400;
    _input_desc.inf_crop[1].crop_number = 1; // crop number for sync, could be specified by user
    _input_desc.inf_crop[1].x1 = 230;
    _input_desc.inf_crop[1].y1 = 335;
    _input_desc.inf_crop[1].width = 450;
    _input_desc.inf_crop[1].height = 450;
    ...
    post_process_yolo_v3(output_nodes, _output_desc_0.num_output_node, &_output_desc_0.pre_proc_info, 0.2, yolo_result);
    ...
    // post-process yolo v3 output nodes to class/bounding boxes
    post_process_yolo_v3(output_nodes, _output_desc_1.num_output_node, &_output_desc_1.pre_proc_info, 0.2, yolo_result);
