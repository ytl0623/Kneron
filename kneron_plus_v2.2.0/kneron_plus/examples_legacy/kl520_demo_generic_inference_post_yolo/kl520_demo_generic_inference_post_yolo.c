/**
 * @file        kl520_demo_generic_inference_post_yolo.c
...
int main(int argc, char *argv[])
{
    ...
    post_process_yolo_v3(output_nodes, _output_desc.num_output_node, &_output_desc.pre_proc_info, 0.2, yolo_result);
