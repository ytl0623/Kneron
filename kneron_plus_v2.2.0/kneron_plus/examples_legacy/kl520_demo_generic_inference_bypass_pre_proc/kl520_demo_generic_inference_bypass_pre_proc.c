/**
 * @file        kl520_demo_generic_inference_bypass_pre_proc.c
...
static char _image_file_path[128] = "../../res/images/bike_cars_street_224x224_rgba8888_normalized.bin";
...
static int _img_width = 224;
static int _img_height = 224;
