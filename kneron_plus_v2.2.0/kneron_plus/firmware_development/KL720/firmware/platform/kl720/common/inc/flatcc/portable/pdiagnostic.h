 ...
 * 
 * #define PDIAGNOSTIC_IGNORE_ASSERT // for armcc microlib option
 *
...
#if defined(__CC_ARM)
#pragma diag_suppress 177 // ignore warnning: <entity> was declared but never referenced
#else
...
#if defined(__CC_ARM)
#pragma diag_suppress 1293 // ignore warnning: assignment in condition
#endif
