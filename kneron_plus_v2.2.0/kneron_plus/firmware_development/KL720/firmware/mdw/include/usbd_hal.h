...
#if defined(RMI_COMM_IF) && (RMI_COMM_IF == RMI_FUNC_USB_IF)
#define KDP2_USB_ENDPOINT_RMI_IN KDP2_USB_ENDPOINT_DATA_IN
#define KDP2_USB_ENDPOINT_RMI_OUT KDP2_USB_ENDPOINT_DATA_OUT
#endif

typedef enum
{
    USBD_STATUS_DISCONNECTED = 0x0,
